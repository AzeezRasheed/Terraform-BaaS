...
variable "self_service_portal_saml_metadata_document" {
  default     = null
  description = "Optional SAML metadata document. Must include this or `self_service_portal_saml_provider_arn`"
  type        = string
}
